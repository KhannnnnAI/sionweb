...
// ==========================================================================
//   HANDLER: /api/soundcloud-profile
// ==========================================================================
...
module.exports = async function handler(req, res) {
  // CORS Headers cho Vercel & môi trường khác
  ...
  try {
    ...
    return res.status(500).json({ error: 'Không thể lấy dữ liệu SoundCloud Profile: ' + err.message });
  }
};
